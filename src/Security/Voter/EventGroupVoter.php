...
{
    const EVENT_GROUP_VIEW_ROLE = 'EVENT_GROUP_VIEW_ROLE'.__CLASS__;
    const EVENT_GROUP_EDIT_ROLE = 'EVENT_GROUP_EDIT_ROLE'.__CLASS__;
    const EVENT_GROUP_ADD_ROLE = 'EVENT_GROUP_ADD_ROLE'.__CLASS__;
    const EVENT_GROUP_LIST_ROLE = 'EVENT_GROUP_LIST_ROLE'.__CLASS__;

    protected function supports($attribute, $subject)
    {
        // if the attribute isn't one we support, return false
        if (!in_array($attribute, [
            self::EVENT_GROUP_VIEW_ROLE,
            self::EVENT_GROUP_EDIT_ROLE,
            self::EVENT_GROUP_ADD_ROLE,
            self::EVENT_GROUP_LIST_ROLE,
        ], true)) {
            return false;
        }
