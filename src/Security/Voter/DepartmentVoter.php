...
{
    const DEPARTMENT_VIEW_ROLE = 'DEPARTMENT_VIEW_ROLE'.__CLASS__;
    const DEPARTMENT_EDIT_ROLE = 'DEPARTMENT_EDIT_ROLE'.__CLASS__;
    const DEPARTMENT_ADD_ROLE = 'DEPARTMENT_ADD_ROLE'.__CLASS__;
    const DEPARTMENT_LIST_ROLE = 'DEPARTMENT_LIST_ROLE'.__CLASS__;

    protected function supports($attribute, $subject)
    {
        // if the attribute isn't one we support, return false
        if (!in_array($attribute, [
            self::DEPARTMENT_VIEW_ROLE,
            self::DEPARTMENT_EDIT_ROLE,
            self::DEPARTMENT_ADD_ROLE,
            self::DEPARTMENT_LIST_ROLE,
        ], true)) {
            return false;
        }
    ...
    {
        switch ($attribute) {
            case self::DEPARTMENT_LIST_ROLE:
