...
class EventKindVoter extends Voter
{
    const EVENT_KIND_VIEW_ROLE = 'EVENT_KIND_VIEW_ROLE'.__CLASS__;
    const EVENT_KIND_EDIT_ROLE = 'EVENT_KIND_EDIT_ROLE'.__CLASS__;
    const EVENT_KIND_ADD_ROLE = 'EVENT_KIND_ADD_ROLE'.__CLASS__;
    const EVENT_KIND_LIST_ROLE = 'EVENT_KIND_LIST_ROLE'.__CLASS__;

    protected function supports($attribute, $subject)
    {
        // if the attribute isn't one we support, return false
        if (!in_array($attribute, [
            self::EVENT_KIND_VIEW_ROLE,
            self::EVENT_KIND_EDIT_ROLE,
            self::EVENT_KIND_ADD_ROLE,
            self::EVENT_KIND_LIST_ROLE,
        ], true)) {
            return false;
        }
